...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_employee'])) {
        ...
        // Call the addEmployee method from the Employee class to add a new employee
        if ($employee->addEmployee($first_name, $last_name, $department, $email)) {
            // Employee added successfully, you can provide a success message
            echo "Employee added successfully!";
        } else {
            // Failed to add employee, display an error message
        ...
        // Call the updateEmployee method from the Employee class to update employee information
        if ($employee->updateEmployee($employee_id, $first_name, $last_name, $department, $email)) {
            // Employee information updated successfully, you can provide a success message
            echo "Employee information updated successfully!";
        } else {
            // Failed to update employee information, display an error message
